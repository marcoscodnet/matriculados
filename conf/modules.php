...
/**
 * se configuran los módulos de cpiq.
 *
...
define('CACHE_ID', "cpiq");

define('CPIQ_PATH', APP_PATH . '/classes/com/cpiq/');
define('CPIQ_PATH_TEST', APP_PATH . '/unit_test/');
...
define('APP_NAME', 'CPIQ');
define('CDT_MVC_APP_TITLE', 'CPIQ');
define('CDT_MVC_APP_SUBTITLE', 'Matriculados');
...
//recuperar clave
define("CDT_SECURE_FORGOT_PASSWORD_LAYOUT", 'LayoutCPIQLogin');
...
define ( 'DEFAULT_LAYOUT', 'LayoutCPIQ' );
define ( 'DEFAULT_PANEL_LAYOUT', 'LayoutCPIQ');
define ( 'DEFAULT_EDIT_LAYOUT', 'LayoutCPIQ' );
define ( 'DEFAULT_LOGIN_LAYOUT', 'LayoutCPIQLogin' );
...
if (!defined('CLASS_PATH_EXCLUDE')) {
	...
	$exclude[] = CPIQ_PATH . 'view/templates';
	$exclude[] = '.svn';
