...
/**
 * Formulario para Pagar Cuota/s Registros
 *
 * @author Marcos
 * @since 20-03-2017
 */
class CMPPagarRegistroCuotaMatriculadoForm extends CMPForm{
	 ...
	 */
	public function __construct($action="", $id="edit_pagarRegistroCuotaMatriculado") {
		...
		$this->setOnCancel("window.location.href = 'doAction?action=list_registrosCuotaMatriculado';");
