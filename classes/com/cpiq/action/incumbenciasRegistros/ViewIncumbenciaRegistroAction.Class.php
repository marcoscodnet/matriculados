...
/**
 * Acción para visualizar un incumbenciaRegistro.
 *
 * @author Marcos
 * @since 26-09-2013
 *
 */
class ViewIncumbenciaRegistroAction extends UpdateIncumbenciaRegistroInitAction {
	...
	protected function parseEntity($entity, XTemplate $xtpl) {
		...
		$xtpl->assign('fechaUltModificacion_label', CPIQ_LBL_INCUMBENCIA_REGISTRO_FECHA_ULTIMA_MODIFICACION);
		...
		$xtpl->assign('usuario_label', CPIQ_LBL_INCUMBENCIA_REGISTRO_USUARIO_ULTIMA_MODIFICACION);
	...
	protected function getOutputTitle() {
		return CPIQ_MSG_INCUMBENCIA_REGISTRO_TITLE_VIEW;
	}
