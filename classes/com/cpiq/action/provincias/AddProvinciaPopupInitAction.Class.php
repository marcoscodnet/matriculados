...
/**
 * Acción para dar de alta una provincia en un popup.
 * 
 * @author bernardo
 * @since 06/06/2013
 */
class AddProvinciaPopupInitAction  extends AddProvinciaInitAction {
	...
	public function getNewEntityInstance(){
		$provincia =  parent::getNewEntityInstance();
		$provincia->setNombre( urldecode( CdtUtils::getParam("text") ) );
		return $provincia;
	}
