...
/**
 * Helper DAO para administrar en sesión los registros de una 
 * encomienda.
 *  
 * @author Bernardo
 * @since 08-10-2013
 */
class EncomiendaRegistroSessionDAO extends EntityDAO {
    ...
    public function addEntity( $entity, $idConn=0 ) {
    	...
    	if (!$registros->existObjectComparator($entity, new RegistroComparator())) {	
    ...
    public function deleteEntity($oid, $idConn=0) {
    	...
    	foreach ($registros as $registro) {
    		...
    		if( $registro->getRegistroMatriculado()->getOid() != $oid ){
