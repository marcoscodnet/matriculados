...
/**
 * Acción para visualizar un incumbenciaTipoTitulo.
 *
 * @author Marcos
 * @since 26-09-2013
 *
 */
class ViewIncumbenciaTipoTituloAction extends UpdateIncumbenciaTipoTituloInitAction {
	...
	protected function parseEntity($entity, XTemplate $xtpl) {
		...
		$xtpl->assign('fechaUltModificacion_label', CPIQ_LBL_INCUMBENCIA_TIPO_TITULO_FECHA_ULTIMA_MODIFICACION);
		...
		$xtpl->assign('usuario_label', CPIQ_LBL_INCUMBENCIA_TIPO_TITULO_USUARIO_ULTIMA_MODIFICACION);
	...
	protected function getOutputTitle() {
		return CPIQ_MSG_INCUMBENCIA_TIPO_TITULO_TITLE_VIEW;
	}
